...
export default function AmericanExpressIcon (props) {
  return(
    <SvgIcon viewBox="0 0 60 40" {...props}>
      <g>
      	<g>
      		...
      		<path fill="#5DBBE6" d="M58.531,1.469C59.438,2.375,60,3.625,60,5v15v15c0,1.375-0.562,2.625-1.469,3.531
      			C57.624,39.438,56.375,40,55,40H30H5c-1.375,0-2.625-0.562-3.531-1.469L58.531,1.469z"/>
      		<g>
      			<path fill="#FFFFFF" d="M17.555,24.922l-0.457-1.74h-3.015l-0.47,1.74h-2.755l3.028-9.318h3.346l3.064,9.318H17.555z
      			...
      			<path fill="#FFFFFF" d="M25.344,24.922l-1.897-6.685h-0.058c0.089,1.138,0.133,2.022,0.133,2.654v4.03h-2.221V15.64h3.338
      			...
      			<path fill="#FFFFFF" d="M39.119,24.922h-5.51v-9.281h5.51v2.013h-3.004v1.46h2.781v2.012h-2.781v1.752h3.004V24.922z"/>
      			<path fill="#FFFFFF" d="M49.104,24.922h-2.899l-1.812-2.9l-1.789,2.9h-2.838l3.078-4.748l-2.895-4.533h2.781l1.676,2.869
      	...
      	<g>
      		<path fill="#9CCEDF" d="M55,1c2.206,0,4,1.794,4,4v30c0,2.206-1.794,4-4,4H5c-2.206,0-4-1.794-4-4V5c0-2.206,1.794-4,4-4H55 M55,0
